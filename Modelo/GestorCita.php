...
'$paciente','$medico','$consultorio','$estado','$observaciones')";
    ...
    public function consultarMedicoss()
    {
        $conexion = new Conexion();
        $conexion->abrir();
    ...
    public function agregarMedico(Medico $medico)
    {
        $conexion = new Conexion();
        $conexion->abrir();
        $medIdentificacion = $medico->obtenerIdentificacion();
        $medNombres = $medico->obtenerNombres();
        $medApellidos = $medico->obtenerApellidos();
        $sql = "INSERT INTO medicos VALUES ('$medIdentificacion','$medNombres','$medApellidos')";
        $conexion->consulta($sql);
        $filasAfectadas = $conexion->obtenerFilasAfectadas();
        $conexion->cerrar();
        return $filasAfectadas;
